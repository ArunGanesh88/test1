...
function adminer_object() {
  ...
  class AdminerSoftware extends Adminer {
    ...
    function name() {
      ...
      return "<a href = 'http://localhost:8081/'><-Back</a>";
    }
    
    function permanentLogin() {
      // key used for permanent login
      return "b8aa641ee6651974c39cd174a1873c96";
    }
    
    function credentials() {
      // server, username and password for connecting to database
      return array('localhost:3306', 'root', '');
    }
    
    function database() {
      // database name, will be escaped by Adminer
      return 'VGE_CDRGeneration';
    } 
  }
...
selectLimitProcess(){return(isset($_GET["limit"])?$_GET["limit"]:"10000");}function
...
dumpOutput(){$J=array('file'=>lang(63));return$J;}function
dumpFormat(){return
array('csv'=>'CSV');}function
...
tablesPrint($T){echo"<ul id='tables' onmouseover='menuOver(this, event);' onmouseout='menuOut(this);' Style='display:none'>\n";foreach($T
...
<title>Vodafone Admin Module</title>
...
lang(251).":",pagination(0,$E).($E>1?" ...":""),($E?pagination($E,$E):""),($ne>$E?pagination($E+1,$E).($ne>$E+1?" ...":""):"");}}echo"<p class='count' style='display:none'>\n",($Wc!==false?"(".($wc?"":"~ ").lang(142,$Wc).") ":"");$Ub=($wc?"":"~ ").$Wc;echo
checkbox("all",1,0,lang(255),"var checked = formChecked(this, /check/); selectCount('selected', this.checked ? '$Ub' : checked); selectCount('selected2', this.checked || !checked ? '$Ub' : checked);")."\n";if($b->selectCommandPrint()){echo'<fieldset style = "display:none"',($_GET["modify"]?'':' class="jsonly"'),'><legend>',lang(247),'</legend><div>
<input type="submit" value="',lang(14),'"',($_GET["modify"]?'':' title="'.lang(243).'"'),'>
</div></fieldset>
<fieldset style="display:none"><legend>',lang(118),' <span id="selected"></span></legend><div>
