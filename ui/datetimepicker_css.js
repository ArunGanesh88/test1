...
var CalPosOffsetY = -198; //Y position offset relative to calendar icon, can be negative value
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		vCalTime += "<td width='22px'><input type='text' name='hour' maxlength=2 size=1 style=\"WIDTH:20px;font-family: verdana,arial,sans-serif;font-size:11px;\" value=" + showHour + " onkeyup=\"javascript:Cal.SetHour(this.value)\">";
		vCalTime += "</td><td style='font-weight:bold;text-align:center;'>:</td><td width='22px'>";
		vCalTime += "<input type='text' name='minute' maxlength=2 size=1 style=\"WIDTH: 22px;font-family: verdana,arial,sans-serif;font-size:11px;\" value='00' onkeyup=\"javascript:Cal.SetMinute(this.value)\">";

		if (Cal.ShowSeconds)
		{
		    vCalTime += "</td><td style='font-weight:bold;'>:</td><td width='22px'>";
			vCalTime += "<input type='text' name='second' maxlength=2 size=1 style=\"WIDTH: 22px;font-family: verdana,arial,sans-serif;font-size:11px;\" value='00' onkeyup=\"javascript:Cal.SetSecond(parseInt(this.value,10))\">";
		}
